...
const Contact = () => {
  ...
  return (
    <div
      className={`xl:mt-10 flex xl:flex-row flex-col- gap-10 overflow-hidden items-center`}
    >
      <motion.div
        variants={slideIn("left", "tween", 0.2, 1)}
        className='flex-[0.75] bg-black-100 p-8 rounded-2xl h-fit w-96 box-content mt-14'
      >
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              placeholder="Qual é seu melhor nome?"
          ...
          <label className='flex flex-col'>
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="Qual é o seu email na web?"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
